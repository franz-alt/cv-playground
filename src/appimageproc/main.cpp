...
int main(int argc, char * argv[])
{
    ...
    std::uint32_t tensorflow_model_outputs = 0;
    ...
    image_processing_options.add_options()
        ...
        ("tfoutputs", po::value<std::uint32_t>(&tensorflow_model_outputs), "amount of outputs generated by TensorFlow model")
    ...
    if (variables.count("tfmodel"))
    {
        ...
        {
            std::cerr << "TensorFlow model set but no amount of outputs set." << std::endl;
            return 1;
        }
    }
