...
#ifndef LIBCVPG_IMAGEPROC_SCRIPTING_ALGORITHMS_CONVERT_TO_GRAY_HPP
#define LIBCVPG_IMAGEPROC_SCRIPTING_ALGORITHMS_CONVERT_TO_GRAY_HPP
...
class convert_to_gray : public base
{
public:
    virtual ~convert_to_gray() override = default;
...
#endif // LIBCVPG_IMAGEPROC_SCRIPTING_ALGORITHMS_CONVERT_TO_GRAY_HPP
