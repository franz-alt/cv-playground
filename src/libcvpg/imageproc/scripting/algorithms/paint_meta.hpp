...
#ifndef LIBCVPG_IMAGEPROC_SCRIPTING_ALGORITHMS_PAINT_META_HPP
#define LIBCVPG_IMAGEPROC_SCRIPTING_ALGORITHMS_PAINT_META_HPP

#include <libcvpg/imageproc/scripting/algorithms/base.hpp>

namespace cvpg::imageproc::scripting::algorithms {

class paint_meta : public base
{
public:
    virtual ~paint_meta() override = default;
...
#endif // LIBCVPG_IMAGEPROC_SCRIPTING_ALGORITHMS_PAINT_META_HPP
