...
#ifndef LIBCVPG_IMAGEPROC_SCRIPTING_ALGORITHMS_POOLING_HPP
#define LIBCVPG_IMAGEPROC_SCRIPTING_ALGORITHMS_POOLING_HPP

#include <libcvpg/imageproc/scripting/algorithms/base.hpp>

namespace cvpg::imageproc::scripting::algorithms {

class pooling : public base
{
public:
    virtual ~pooling() override = default;
...
#endif // LIBCVPG_IMAGEPROC_SCRIPTING_ALGORITHMS_POOLING_HPP
