#ifndef LIBCVPG_IMAGEPROC_SCRIPTING_ALGORITHMS_SCHARR_HPP
#define LIBCVPG_IMAGEPROC_SCRIPTING_ALGORITHMS_SCHARR_HPP
...
class scharr : public base
{
public:
    virtual ~scharr() override = default;
...
#endif // LIBCVPG_IMAGEPROC_SCRIPTING_ALGORITHMS_SCHARR_HPP
