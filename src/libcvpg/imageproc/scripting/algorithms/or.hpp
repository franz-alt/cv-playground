...
#ifndef LIBCVPG_IMAGEPROC_SCRIPTING_ALGORITHMS_OR_HPP
#define LIBCVPG_IMAGEPROC_SCRIPTING_ALGORITHMS_OR_HPP

#include <libcvpg/imageproc/scripting/algorithms/base.hpp>

namespace cvpg::imageproc::scripting::algorithms {

class or_ : public base
{
public:
    virtual ~or_() override = default;
...
#endif // LIBCVPG_IMAGEPROC_SCRIPTING_ALGORITHMS_OR_HPP
