        ...
        try
        {
            ...
            if (input.type() == cvpg::imageproc::scripting::item::types::grayscale_8_bit_image)
            {
                ...
                boost::asynchronous::create_callback_continuation(
                    ...
                    cvpg::imageproc::algorithms::tiling(image, cvpg::imageproc::algorithms::tiling_params { cvpg::imageproc::algorithms::tiling_algorithms::mean, cutoff_x, cutoff_y, 0.0, 0, 0, 0, width, height })
                );
            }
